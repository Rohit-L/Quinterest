...
echo "Bonus $i Intro: <input type='text' name='intro' /><br />Part 1: <input type='text' name='question1' /><br />Answer: <input type='text' name='answer1' /><br />Part 2: <input type='text' name='question2' /><br />Answer: <input type='text' name='answer2' /><br />Part 3: <input type='text' name='question3' /><br />Answer: <input type='text' name='answer3' /><br />";
